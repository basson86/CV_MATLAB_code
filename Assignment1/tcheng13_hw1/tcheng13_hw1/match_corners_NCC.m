function [m1,m2] = match_corners_NCC(I1,I2,corners1,corners2,ws);
...
% building up the look-up table storing the NCC
for i= 1:Num_Matching
 ...
 for j= 1:Num_Matching
     ...
     %Intensity of corner 2
      ...
      % storing the score value to the look-up table- MScore
      MScore(i,j)= C;
